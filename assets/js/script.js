...
form.addEventListener('submit', (e) => {
	...
	fetch(
		`https://api.telegram.org/bot${post.botTOKEN}/sendMessage?chat_id=${post.chatId}&text=📩: ${message.value} `,
		{
			method: 'GET',
		},
	).then(
        (success) => {
            ...
            Toastify({
                ...
                style: {
                    background: 'linear-gradient(to right, #3e6eff, #3e6eff,#3e6eff)',
                },
                duration: 3000,
            }).showToast();
        },
